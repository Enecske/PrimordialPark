...
public class GeckoAnimations {
    public static final AnimationDefinition GECKO_IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
    ...
    public static final AnimationDefinition GECKO_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("Head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition GECKO_SWIM = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition GECKO_SLEEP = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.POSITION,
